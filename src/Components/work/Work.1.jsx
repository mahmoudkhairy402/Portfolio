  ...
  return (
    <>
      ...
      <div className="row work">
        ...
        <div className="container  row mt-3 g-2 justify-content-around align-items-center">
          {projectsArr.map((ele) => {
            return (
              <Bounce className="w-auto">
                <div
                  key={ele.projectName}
                ...
                >
                  <div className="card-content">
                    ...
                    <div className="content">
                      <h3 className="project-title">{ele.projectName}</h3>
                      <p className="project-desc">{ele.projectDesc}</p>
                      <div className="links">
                        <a href={ele.projectGithup}>
                          <svg
                            id="links-icon "
                        ...
                        <a href={ele.projectGithup} className="more-link">
                          more
                        </a>
                      </div>
                    </div>
